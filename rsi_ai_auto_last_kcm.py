    ...
    while n < len(all_coin) : #총 코인 갯수
        try:
            ...
            if start_time + datetime.timedelta(seconds=600) < now < end_time - datetime.timedelta(seconds=60):
                ...
                rsiindex(coin)
                if rsi < 23 and predicted_close_price/current_price > 1.10 and (count1 == 'true' or count2 == 'true' or count3 == 'true') and (upbit.get_balance(coin[4:]) == 0):
                    if count1 == 'true':
                ...
                if (count1 == 'false') and ((water_buy_price_0 * 1.03) < (get_current_price(buycoin_0))) :
                    ...
                    web1_5 = 'false'
                #물타기
                elif (count1 == 'false') and ((buy_price_0 * 0.98) > (get_current_price(buycoin_0))) and (web1_1 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 50000:
                        upbit.buy_market_order(buycoin_0, 50000)
                        #water_current_price1_1 = get_current_price(buycoin_0)
                        time.sleep(1)
                        water_buy_price_0 = 100000/(upbit.get_balance(buycoin_0[4:]))
                    web1_1 = 'true'
                elif (count1 == 'false') and ((buy_price_0 * 0.97) > (get_current_price(buycoin_0))) and (web1_2 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 20000:
                        upbit.buy_market_order(buycoin_0, 20000) 
                        #water_current_price1_2 = get_current_price(buycoin_0)
                        time.sleep(1)
                        water_buy_price_0 = 120000/(upbit.get_balance(buycoin_0[4:]))
                    web1_2 = 'true'
                elif (count1 == 'false') and ((buy_price_0 * 0.96) > (get_current_price(buycoin_0))) and (web1_3 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 20000:
                        upbit.buy_market_order(buycoin_0, 20000) 
                        #water_current_price1_3 = get_current_price(buycoin_0)
                        time.sleep(1)
                        water_buy_price_0 = 140000/(upbit.get_balance(buycoin_0[4:]))
                    web1_3 = 'true'
                elif (count1 == 'false') and ((buy_price_0 * 0.95) > (get_current_price(buycoin_0))) and (web1_4 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 20000:
                        upbit.buy_market_order(buycoin_0, 20000) 
                        #water_current_price1_4 = get_current_price(buycoin_0)
                        time.sleep(1)
                        water_buy_price_0 = 160000/(upbit.get_balance(buycoin_0[4:]))
                    web1_4 = 'true'
                ...
                if (count2 == 'false') and ((water_buy_price_1 * 1.03) < (get_current_price(buycoin_1))) :
                    ...
                    web2_5 = 'false'
                #물타기
                elif (count2 == 'false') and ((buy_price_1 * 0.98) > (get_current_price(buycoin_1))) and (web2_1 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 50000:
                        upbit.buy_market_order(buycoin_1, 50000)
                        #water_current_price1_1 = get_current_price(buycoin_1)
                        time.sleep(1)
                        water_buy_price_1 = 100000/(upbit.get_balance(buycoin_1[4:]))
                    web2_1 = 'true'
                elif (count2 == 'false') and ((buy_price_1 * 0.97) > (get_current_price(buycoin_1))) and (web2_2 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 20000:
                        upbit.buy_market_order(buycoin_1, 20000) 
                        #water_current_price1_2 = get_current_price(buycoin_1)
                        time.sleep(1)
                        water_buy_price_1 = 120000/(upbit.get_balance(buycoin_1[4:]))
                    web2_2 = 'true'
                elif (count2 == 'false') and ((buy_price_1 * 0.96) > (get_current_price(buycoin_1))) and (web2_3 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 20000:
                        upbit.buy_market_order(buycoin_1, 20000) 
                        #water_current_price1_3 = get_current_price(buycoin_1)
                        time.sleep(1)
                        water_buy_price_1 = 140000/(upbit.get_balance(buycoin_1[4:]))
                    web2_3 = 'true'
                elif (count2 == 'false') and ((buy_price_1 * 0.95) > (get_current_price(buycoin_1))) and (web2_4 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 20000:
                        upbit.buy_market_order(buycoin_1, 20000) 
                        #water_current_price1_4 = get_current_price(buycoin_1)
                        time.sleep(1)
                        water_buy_price_1 = 160000/(upbit.get_balance(buycoin_1[4:]))
                    web2_4 = 'true'
                ...
                #    web3_2 = 'true'
                elif (count3 == 'false') and ((buy_price_2 * 0.98) > (get_current_price(buycoin_2))) and (web3_1 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 50000:
                        upbit.buy_market_order(buycoin_2, 50000)
                        #water_current_price1_1 = get_current_price(buycoin_2)
                        time.sleep(1)
                        water_buy_price_2 = 100000/(upbit.get_balance(buycoin_2[4:]))
                    web3_1 = 'true'
                elif (count3 == 'false') and ((buy_price_2 * 0.97) > (get_current_price(buycoin_2))) and (web3_2 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 20000:
                        upbit.buy_market_order(buycoin_2, 20000) 
                        #water_current_price1_2 = get_current_price(buycoin_2)
                        time.sleep(1)
                        water_buy_price_2 = 120000/(upbit.get_balance(buycoin_2[4:]))
                    web3_2 = 'true'
                elif (count3 == 'false') and ((buy_price_2 * 0.96) > (get_current_price(buycoin_2))) and (web3_3 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 20000:
                        upbit.buy_market_order(buycoin_2, 20000) 
                        #water_current_price1_3 = get_current_price(buycoin_2)
                        time.sleep(1)
                        water_buy_price_2 = 140000/(upbit.get_balance(buycoin_2[4:]))
                    web3_3 = 'true'
                elif (count3 == 'false') and ((buy_price_2 * 0.95) > (get_current_price(buycoin_2))) and (web3_4 == 'false'):
                    krw = get_balance("KRW")
                    if krw > 20000:
                        upbit.buy_market_order(buycoin_2, 20000) 
                        #water_current_price1_4 = get_current_price(buycoin_2)
                        time.sleep(1)
                        water_buy_price_2 = 160000/(upbit.get_balance(buycoin_2[4:]))
                    web3_4 = 'true'
